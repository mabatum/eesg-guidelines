...
def homepage_markdown(publish: list[str]) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "Выделите фрагмент текста и нажмите «Замечание» рядом с ним "
            "или используйте кнопку «Оставить замечание» для отзыва ко всей странице.",
            "",
            "Для отправки замечаний не требуется вход в GitHub или Google. "

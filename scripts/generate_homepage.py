...
SECTION_LEAD = {
    "bone-sarcomas": "Диагностика и лечение первичных опухолей кости у взрослых.",
...
def homepage_markdown(publish: list[str]) -> str:
    ...
    lines.extend(
        [
            ...
            "Доступные разделы: " + ", ".join(title for title, _, _ in sections(publish)) + ". "
            "Сайт работает в тестовом режиме; остальные разделы находятся в работе.",
            "",
